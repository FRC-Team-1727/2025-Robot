...
public class AutonAlgaeAlign extends Command{
    ...
    public AutonAlgaeAlign(CommandSwerveDrivetrain drivetrain, Optional<LeftOrRight> leftOrRight, CommandXboxController joystick){
