...
public class RobotStateEstimator extends SubsystemBase {
  ...
  public void periodic() {
    if (useMT2) {
      ...
      SmartDashboard.putNumber("LimeLightLeft xPose", mt1Left.pose.getX());
      SmartDashboard.putNumber("LimeLightLeft yPose", mt1Left.pose.getY());
      SmartDashboard.putNumber("LimeLightRight xPose", mt1Right.pose.getX());
      SmartDashboard.putNumber("LimeLightRight yPose", mt1Right.pose.getY());
    }
  }
}
