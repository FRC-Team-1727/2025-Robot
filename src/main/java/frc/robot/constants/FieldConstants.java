...
public class FieldConstants {
    ...
    public static void configureReefPositions(Alliance alliance){
        ...
        Pose2d REEF_C = findPose(3.684, 2.988, Math.PI / 3);
        Pose2d REEF_D = findPose(3.976, 2.821, Math.PI / 3);
        Pose2d REEF_E = findPose(4.972, 2.851, 2 * Math.PI / 3);
        Pose2d REEF_F = findPose(5.294, 2.988, 2 * Math.PI / 3);
        Pose2d REEF_G = findPose(5.776, 3.840, Math.PI);
        Pose2d REEF_H = findPose(5.776, 4.192, Math.PI);
        Pose2d REEF_I = findPose(5.276, 5.026, -2 * Math.PI / 3);
        Pose2d REEF_J = findPose(4.958, 5.164, -2 * Math.PI / 3);
        Pose2d REEF_K = findPose(4, 5.164, -Math.PI / 3);
        Pose2d REEF_L = findPose(3.732, 5.062, -Math.PI/3);
